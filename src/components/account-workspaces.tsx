...
export function SettingsWorkspace() {
  ...
  if (!settings) return notice ? <div className="empty-ledger"><X size={22} /><strong>Settings could not be loaded</strong><span>{notice}</span></div> : <div className="empty-ledger"><strong>Loading settings</strong></div>;
